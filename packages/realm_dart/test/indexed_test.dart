  ...
  for (final testCase in indexedTestData) {
    test('Indexed faster: ${testCase.name}', () {
      ...
      final indexed = List.generate(
        max,
        (i) => WithIndexes(intFactory(i), boolFactory(i), stringFactory(i), timestampFactory(i), objectIdFactory(i), uuidFactory(i)),
      );
      ...
      final notIndexed = List.generate(
        max,
        (i) => NoIndexes(intFactory(i), boolFactory(i), stringFactory(i), timestampFactory(i), objectIdFactory(i), uuidFactory(i)),
      );
