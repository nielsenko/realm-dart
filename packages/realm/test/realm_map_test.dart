...
List<TestCaseData<Uint8List>> byteArrayTestValues() => [
  ...
  TestCaseData(
    ...
    initialValues: [('a', byteArray1), ('b', byteArray1), ('c', byteArray1)],
    equalityFunc: IterableEquality().equals,
  ),
  TestCaseData(
    Uint8List.fromList([1, 2, 3]),
    initialValues: [('a', byteArray0), ('b', byteArray1), ('c', byteArray2)],
    equalityFunc: IterableEquality().equals,
  ),
  TestCaseData(
    Uint8List.fromList([1, 2, 3]),
...
List<TestCaseData<Uint8List?>> nullableByteArrayTestValues() => [
  ...
  TestCaseData(
    Uint8List.fromList([1, 2, 3]),
    initialValues: [('a', byteArray2), ('b', null), ('c', byteArray1), ('d', byteArray0)],
    equalityFunc: IterableEquality().equals,
  ),
  TestCaseData(
    Uint8List.fromList([1, 2, 3]),
    ...
    for (final testData in invalidKeys) {
      test('Invalid key: ${testData.key}', () {
        ...
        realm.write(() {
          final testObject = realm.add(TestRealmMaps(0));
          expect(
            () => testObject.stringMap[testData.key] = 'value',
