...
void main() {
  ...
  final ringAroundMugaritz = ring([(-2.0, 43.3), (-1.9, 43.3), (-1.9, 43.2)]);
  ...
  for (final (shape, restaurants) in [
    ...
    (GeoPolygon(ringAroundAll), [noma, theFatDuck, mugaritz]),
    (GeoPolygon(ringAroundAll, [ringAroundNoma]), [theFatDuck, mugaritz]),
    (GeoPolygon(ringAroundAll, [ringAroundNoma, ringAroundTheFatDuck]), [mugaritz]),
  ...
  test('GeoPoint', () {
    final validPoints = <(double, double)>[(0.0, 0.0), (double.minPositive, 0)];
