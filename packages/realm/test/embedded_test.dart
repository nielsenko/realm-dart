...
import 'package:realm/src/realm_class.dart' show RealmInternal;
import 'package:realm/src/realm_object.dart';
...
void main() {
  ...
  test('Embedded object get/set properties', () {
    ...
    final graph = ObjectWithEmbedded(
      'TopLevel1',
      recursiveObject: RecursiveEmbedded1(
        'Child1',
        child: RecursiveEmbedded2('Child2'),
        children: [
  ...
  test('Parent with embedded addOrUpdate correctly propagates graph', () {
    ...
    final newGraph = ObjectWithEmbedded(
      '456',
  ...
  test('Parent, when deleted cleans up embedded graph', () {
    ...
    final parent = ObjectWithEmbedded(
      '123',
      recursiveList: [
        RecursiveEmbedded1(
          '1.1',
          child: RecursiveEmbedded2('2.1', child: RecursiveEmbedded3('3.1'), children: [RecursiveEmbedded3('3.2')]),
        ),
      ...
      realm.write(() {
        realm.add(
          ObjectWithEmbedded(
            ...
            recursiveObject: RecursiveEmbedded1(
              '1.1',
              child: RecursiveEmbedded2('2.1', child: RecursiveEmbedded3('3.1')),
              children: [RecursiveEmbedded2('2.2')],
            ),
  ...
  test('Embedded object can be frozen', () {
    ...
    final parent = ObjectWithEmbedded(
      '123',
      recursiveList: [RecursiveEmbedded1('1.1'), RecursiveEmbedded1('1.2')],
      recursiveObject: RecursiveEmbedded1('1.3', child: RecursiveEmbedded2('2.3')),
    );
  ...
  test('Embedded list can be frozen', () {
    ...
    final parent = ObjectWithEmbedded('123', recursiveList: [RecursiveEmbedded1('1.1'), RecursiveEmbedded1('1.2')]);
  ...
  test('Embedded list notifications', () async {
    ...
    final parent = ObjectWithEmbedded('123', recursiveList: [RecursiveEmbedded1('1.1')]);
  ...
  test('EmbeddedObject.getParent returns parent', () async {
    ...
    final parent = ObjectWithEmbedded(
      '123',
      recursiveObject: RecursiveEmbedded1('1.1', child: RecursiveEmbedded2('2.1')),
      recursiveList: [RecursiveEmbedded1('1.2')],
    );
